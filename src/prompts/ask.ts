...
กฎ:
- string ทุกตัวเป็น plain text เท่านั้น — ห้าม markdown (**, ##, backtick) และห้าม HTML tag (<b>, <i>, <br> ฯลฯ) เด็ดขาด เพราะ LINE แสดงผลไม่ได้ จะโชว์เป็นตัวอักษรดิบๆ
- ห้ามใช้เครื่องหมาย " ภายในข้อความ (จะทำให้ JSON พัง) — ถ้าต้องการเน้นคำ ใช้ 'คำ' แทน การเน้นข้อความทำไม่ได้ ให้เรียบเรียงประโยคให้เน้นด้วยตัวมันเอง
